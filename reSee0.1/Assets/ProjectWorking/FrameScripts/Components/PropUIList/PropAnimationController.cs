 ...
 [SerializeField] private Vector2 midScale;
  ...
  //[SerializeField] private Vector2 endPosition;
   [SerializeField] private Vector2 endScale;
    ...
    {
        Vector2 tmidPosition;
        Vector2 tmidScale=midScale*theCamera.orthographicSize/10;
        Vector2 tendPosition;
        Vector2 tendScale = endScale * theCamera.orthographicSize/10;
        Vector2 tstartScale=startScale * theCamera.orthographicSize / 10;


        tmidPosition = Camera.main.ScreenToWorldPoint(new Vector3(Screen.width / 2.0f, Screen.height / 2.0f, 0));
        tendPosition = Camera.main.ScreenToWorldPoint(new Vector3(Screen.width, Screen.height / 2.0f, 0));
        ...
        thePropTransform.localScale = tstartScale;
        thePropSpriteRenderer.color = startColora;



        deltaPosition = tmidPosition - startPosition;
        deltaScale = tmidScale - tstartScale;
        ...
        for (float timer = 0; timer < startT; timer += Time.deltaTime)
        {
            ...
            thePropTransform.localScale = tstartScale + deltaScale * interp_normalize_k;
        ...
        thePropTransform.position = tmidPosition;
        thePropTransform.localScale = tmidScale;
        ...
        deltaPosition = tendPosition - tmidPosition;
        deltaScale = tendScale - tmidScale;
        ...
        for (float timer = 0; timer < endT; timer += Time.deltaTime)
        {
            ...
            thePropTransform.position = tmidPosition + deltaPosition * interp_normalize_k + disturbancePos * disturbance_normalize_k;
            thePropTransform.localScale = tmidScale + deltaScale * interp_normalize_k;
        ...
        thePropTransform.position = tendPosition;
        thePropTransform.localScale = tendScale;
